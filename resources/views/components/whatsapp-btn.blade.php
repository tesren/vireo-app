    ...
    <div class="sticky-bottom px-0 py-2 d-block d-lg-none bg-sand border-top border-light">
        <div class="row">
            ...
            <div class="col-5 align-self-center">
                <a class="btn btn-green rounded-0 shadow w-100 fs-6" href="https://wa.me/52{{config('domus.whatsapp_number')}}?text={{__("Hola, vengo del sitio web de Virēo Living")}}" target="_blank" rel="noopener noreferrer">
