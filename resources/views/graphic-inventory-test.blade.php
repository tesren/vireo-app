...
@section('content')
    ...
    <div class="col-12 col-lg-11 col-xxl-10 mx-auto position-relative mb-6 px-2 px-lg-0">

        <img src="{{asset('img/torre-b.jpg')}}" alt="Torre A - Virēo Living" class="w-100 rounded-3 shadow">

        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" class="position-absolute start-0 top-0 px-2 px-lg-0" viewBox="0 0 1920 1080">
            ...
            @foreach ($towerB_units as $unit )
                ...
                <a href="#unit-modal-{{$unit->id}}" data-bs-toggle="modal" data-bs-target="#unit-modal-{{$unit->id}}" class="unit-square text-decoration-none position-relative">
                    ...
                    <text x="{{$unit->shape->text_x ?? 0;}}"
                        ...
                        font-size="22" font-weight="bold" fill="#fff" class="fw-light">
    ...
    <div class="col-12 col-lg-11 col-xxl-10 mx-auto position-relative mb-6 px-2 px-lg-0">
        ...
        <img src="{{asset('img/torre-a.jpg')}}" alt="Torre A - Virēo Living" class="w-100 rounded-3 shadow">
