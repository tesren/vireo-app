...
@section('content')
    ...
    <div class="position-relative mb-6">
        ...
        <div class="row justify-content-center position-absolute top-0 left-0 h-100 z-3">
            <div class="col-11 col-lg-10 col-xl-8 text-center text-sand align-self-center">
                ...
                <h1 class="fs-2 mb-4">
                    Condominios de 1, 2 y 3 recámaras <br> y Villas de 4 recámaras. <br>
    ...
    <footer class="bg-green py-5">
        ...
        <div class="row justify-content-evenly">
            ...
            <div class="col-12 col-lg-3 mb-5 mb-lg-0 align-self-center order-2 order-lg-1">
            ...
            <div class="col-11 col-lg-3 col-xl-2 order-1 order-lg-2">
